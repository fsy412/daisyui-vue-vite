<template lang="">
  <div class=" ">
    <label for="my_modal_6" class="btn bg-[#18181b] font-bold">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-3 h-4 w-4 md:h-6 md:w-6 bg-gray-300" alt="wallet">
        <path
          d="M10 16V8C10
